...
Name: %{?scl_prefix}rubygem-%{gem_name}40
Version: 4.0.18
Release: 12%{?dist}
...
Patch110:       rubygem-passenger-4.0.18-daemon-controller.patch
...
%package -n %{?scl_prefix}mod_passenger40
...
%description -n %{?scl_prefix}mod_passenger40
...
%{__sed} -i \
    ...
    -e 's|%%%%APACHE_INSTALLED_MOD%%%%|%{_httpd24_moddir}|g' \
...
%else
%{__sed} -i 's|@HTTPD_MODDIR@|%{_httpd24_moddir}|' %{buildroot}%{gem_instdir}/lib/phusion_passenger/locations.ini
%endif

# Install Apache module.
%if 0%{?scl:1}
%{__mkdir_p} %{buildroot}/%{_httpd24_moddir}
install -pm 0755 buildout/apache2/mod_passenger.so %{buildroot}/%{_httpd24_moddir}

# Install Apache config.
%{__mkdir_p} %{buildroot}%{_httpd24_confdir} %{buildroot}%{_httpd24_modconfdir}
...
%{__sed} -i 's|@LIBEXECDIR@|%{_libexecdir}|' passenger.conf
...
install -pm 0755 %{SOURCE12} %{buildroot}%{_libexecdir}/httpd24-ruby
...
# Fix shebang of tests in devel subpackage:
for script in `find %{buildroot} -type f -name "*.rb" -o -name "*.cgi" -o -name "*.fcgi"`; do
    sed -i 's|#!/usr/bin/ruby|#!%{_bindir}/ruby|' $script
done
...
%changelog
* Fri May 09 2014 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-12
- rename to rubygem-passenger40 (#1095367)

* Thu Apr 10 2014 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-11
- fix shebangs in devel package (#1084484)

* Fri Feb 28 2014 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-10
- fix libexec script (#1071137)

* Thu Feb 13 2014 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-9
- fix corrupted RI documentation (#1064824)

* Mon Feb 03 2014 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-8
- fix also CVE-2014-1832 (#1059084)

* Wed Jan 29 2014 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-7
- fix a symlink-related security vulnerability (#1059084)

* Tue Nov 26 2013 Joe Orton <jorton@redhat.com> - 4.0.18-6
- disable strict-aliasing

* Tue Nov 26 2013 Joe Orton <jorton@redhat.com> - 4.0.18-5
- drop standalone support

* Mon Nov 18 2013 Jan Kaluza <jkaluza@redhat.com> - 4.0.18-4
- use wrapper for ruby collection to enable it before running ruby
